...
},{"_process":291}],290:[function(require,module,exports){
'use strict';
...
exports.EventEmitterDecorator = EventEmitterDecorator;
exports.on = on;
...
var EventEmitterMixin = (function () {
  function EventEmitterMixin() {
    _classCallCheck(this, EventEmitterMixin);
  }

  _createClass(EventEmitterMixin, [{
    key: 'on',
    value: function on(name, fn) {
      var listeners = this._getListeners(name, true);
      listeners.push(fn);
      return fn;
    }
  }, {
    ...
    value: function emit(name) {
      ...
      do {
        ...
        var newResults = emitter._callListeners(name, this, args);
    ...
    key: '_getListeners',
    value: function _getListeners(name, createIfUndefined) {
    ...
    key: '_callListeners',
    value: function _callListeners(name, thisArg, args) {
      var listeners = this._getListeners(name);
      if (!listeners) return [];
      var results = [];
...
function EventEmitterDecorator(target) {
  target = target.prototype;
  var source = EventEmitterMixin.prototype;
  ...
  try {
    for (var _iterator = names[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      if (_name === 'constructor') continue;
      if (_name in target) {
        throw new Error('"' + _name + '" method is already defined');
      }
      var descriptor = Object.getOwnPropertyDescriptor(source, _name);
      Object.defineProperty(target, _name, descriptor);
    }
  } catch (err) {
...
function on(target, name, descriptor) {
...
exports['default'] = EventEmitterDecorator;
...
var _eventEmitterMixin = require('event-emitter-mixin');

var _eventEmitterMixin2 = _interopRequireDefault(_eventEmitterMixin);

var Canvas = (function () {
    function Canvas(containerElem) {
    ...
    Canvas.prototype.getContainerWidth = function getContainerWidth() {
    ...
    Canvas.prototype.getContainerHeight = function getContainerHeight() {
    ...
    Canvas.prototype.onMouseDown = function onMouseDown(e) {
    ...
    Canvas.prototype.onMouseMove = function onMouseMove(e) {
        var event = 'mouse-move';
        if (this.isMouseDown) {
            event = 'mouse-drag';
        }

        this.emit(event, _util.normaliseMouseEventToElement(this.canvas, e));
    };
    ...
    Canvas.prototype.onMouseUp = function onMouseUp(e) {
        if (this.isMouseDown) {
            this.isMouseDown = false;
            this.emit('mouse-up', _util.normaliseMouseEventToElement(this.canvas, e));
        }
    };
    ...
    Canvas.prototype.setMouseCursor = function setMouseCursor() {
        var type = arguments.length <= 0 || arguments[0] === undefined ? 'crosshair' : arguments[0];
    ...
    Canvas.prototype.publish = function publish() {
    ...
    var _Canvas = Canvas;
    Canvas = _eventEmitterMixin2['default'](Canvas) || Canvas;
    return Canvas;
})();
...
},{"./CanvasImage":293,"./util":298,"event-emitter-mixin":290}],293:[function(require,module,exports){
'use strict';
...
var CanvasImage = (function () {
    function CanvasImage(image, canvas) {
        _classCallCheck(this, _CanvasImage);
    ...
    CanvasImage.prototype.loadImage = function loadImage(imageSrc, cb) {
        var _this = this;
    ...
    CanvasImage.prototype.drawToCanvas = function drawToCanvas(canvasElem, imageObj) {
        var canvas = null;
    ...
    CanvasImage.prototype.redrawToCanvas = function redrawToCanvas() {
    ...
    CanvasImage.prototype.getScaleFactor = function getScaleFactor() {
    ...
    CanvasImage.prototype.drawImageSection = function drawImageSection(sx, sy, sWidth, sHeight) {
    ...
    CanvasImage.prototype.getDataUrl = function getDataUrl() {
        return this.canvas.toDataURL('image/png');
    };

    var _CanvasImage = CanvasImage;
    CanvasImage = _eventEmitterMixin2['default'](CanvasImage) || CanvasImage;
    return CanvasImage;
})();
...
},{"event-emitter-mixin":290}],294:[function(require,module,exports){
'use strict';
...
var _SelectionTool = require('./SelectionTool');

var _SelectionTool2 = _interopRequireDefault(_SelectionTool);
...
function redrawImageWithinSelectionTool(ctx, data) {
    var factor = this.croppableImage.getScaleFactor(),
        actualData = _util.computeActualSizes(data, factor);
...
var Cropper = (function () {
    function Cropper(containerElem) {
        var _this = this;
        ...
        var handleOffset = _ref.handleOffset;

        _classCallCheck(this, _Cropper);

        this.canvas = new _Canvas2['default'](containerElem);
        ...
        ['draw-selection-tool', 'before-selection', 'selection', 'after-selection', 'draw-handle', 'image-load'].forEach(function (eventName) {
            _this.canvas.on(eventName, _this.emit.bind(_this, eventName));
        });

        this.selectTool = new _SelectionTool2['default'](this.canvas, {
    ...
    Cropper.prototype.setImage = function setImage(image) {
        var _this2 = this;
        ...
        this.image = image;
        this.fullSizeImage = new _CanvasImage2['default'](image);
        this.croppableImage = new _CanvasImage2['default'](image, this.canvas.getElement());

        //Make these events public
        ['image-loaded'].forEach(function (eventName) {
            _this2.croppableImage.on(eventName, _this2.emit.bind(_this2, eventName));
        });
    };
    ...
    Cropper.prototype.setAspectRatio = function setAspectRatio(ratio) {
    ...
    Cropper.prototype.setMinimumWidth = function setMinimumWidth(width) {
        var factor = this.croppableImage.getScaleFactor();
    ...
    Cropper.prototype.getCroppedDataUrl = function getCroppedDataUrl(ctx, data) {
        var factor = this.croppableImage.getScaleFactor(),
            actualData = _util.computeActualSizes(data, factor);
    ...
    Cropper.prototype.redrawImage = function redrawImage() {
    ...
    Cropper.prototype.clearSelection = function clearSelection() {
    ...
    Cropper = _eventEmitterMixin2['default'](Cropper) || Cropper;
    return Cropper;
})();
...
},{"./Canvas":292,"./CanvasImage":293,"./SelectionTool":297,"./util":298,"event-emitter-mixin":290}],295:[function(require,module,exports){
'use strict';
...
var ResizeHandle = (function () {
    function ResizeHandle(canvas, corner) {
    ...
    ResizeHandle.prototype.setWidth = function setWidth(width) {
        this.width = width;
    };

    ResizeHandle.prototype.setOffset = function setOffset(offset) {
        this.offset = offset;
    };
    ...
    ResizeHandle.prototype.getBounds = function getBounds() {
        var bounds = {},
            offset = this.offset,
            width = this.width;
    ...
    ResizeHandle.prototype.isCoordWithinBounds = function isCoordWithinBounds(coord) {
        var bounds = this.getBounds();
        return _util.isCoordWithinArea(coord, bounds);
    };
    ...
    ResizeHandle.prototype.getMouseCursor = function getMouseCursor() {
        var map = {
            nw: 'nwse',
            ne: 'nesw',
            sw: 'nesw',
    ...
    ResizeHandle.prototype.draw = function draw(coord) {
        this.coord = coord;
        var bounds = this.getBounds(),
        ...
        this.canvas.publish('draw-handle', ctx, _extends({ corner: corner, width: width, height: height }, bounds));
    };
...
},{"./util":298}],296:[function(require,module,exports){
'use strict';
...
var ResizeHandles = (function () {
    function ResizeHandles(canvas) {
        ...
        _classCallCheck(this, _ResizeHandles);

        this.canvas = canvas;
        this.handles = {};

        ['nw', 'ne', 'sw', 'se'].forEach(function (corner) {
            _this.handles[corner] = new _ResizeHandle2['default'](_this.canvas, corner, { width: width, offset: offset });
        });
    }
    ...
    ResizeHandles.prototype.findHandleAtCoord = function findHandleAtCoord(coord) {
        return this.toArray().find(function (handle) {
            return handle.isCoordWithinBounds(coord);
        });
    };
    ...
    ResizeHandles.prototype.getHandleAtCorner = function getHandleAtCorner(corner) {
    ...
    ResizeHandles.prototype.drawHandles = function drawHandles(bounds) {
    ...
    ResizeHandles.prototype.setOffset = function setOffset(offset) {
        this.toArray().forEach(function (handle) {
    ...
    ResizeHandles.prototype.setWidth = function setWidth(width) {
        this.toArray().forEach(function (handle) {
            handle.setWidth(width);
        });
    };

    ResizeHandles.prototype.toArray = function toArray() {
        return [this.handles.nw, this.handles.ne, this.handles.sw, this.handles.se];
    };

    var _ResizeHandles = ResizeHandles;
    ResizeHandles = _eventEmitterMixin2['default'](ResizeHandles) || ResizeHandles;
...
},{"./ResizeHandle":295,"./util":298,"event-emitter-mixin":290}],297:[function(require,module,exports){
'use strict';
...
var SelectionTool = (function () {
    function SelectionTool(canvas) {
        ...
        var aspectRatio = _ref$aspectRatio === undefined ? '1:1' : _ref$aspectRatio;
        var handleWidth = _ref.handleWidth;
        var handleOffset = _ref.handleOffset;
        ...
        this.resizeHandles = new _ResizeHandles2['default'](this.canvas, {
            width: handleWidth,
            offset: handleOffset
        });
    ...
    SelectionTool.prototype.create = function create(fixed, loose) {
    ...
    SelectionTool.prototype.setFixedCoord = function setFixedCoord(coord) {
    ...
    SelectionTool.prototype.setLooseCoord = function setLooseCoord(coord) {
        var width = coord.x - this.fixedCoord.x,
    ...
    SelectionTool.prototype.setMouseCursor = function setMouseCursor(coord) {
    ...
    SelectionTool.prototype.setAspectRatio = function setAspectRatio(aspectRatio) {
        this.aspectRatio = _util.parseAspectRatio(aspectRatio);
    };
    ...
    SelectionTool.prototype.setMinimumSize = function setMinimumSize() {
        var width = arguments.length <= 0 || arguments[0] === undefined ? 50 : arguments[0];
    ...
    SelectionTool.prototype.getBounds = function getBounds() {
        var top = this.height < 0 ? this.looseCoord.y : this.fixedCoord.y,
    ...
    SelectionTool.prototype.isCoordWithinBounds = function isCoordWithinBounds(coord) {
        if (this.isActive()) {
            var bounds = this.getBounds();
            return _util.isCoordWithinArea(coord, bounds);
        }
    ...
    SelectionTool.prototype.isActive = function isActive() {
    ...
    SelectionTool.prototype.clear = function clear() {
    ...
    SelectionTool.prototype.determineDragAction = function determineDragAction(coord) {
        //Remove current drag handler
        this.canvas.off('mouse-drag');

        var handle = this.isActive() ? this.resizeHandles.findHandleAtCoord(coord) : false,
            dragHandler = null;
    ...
    SelectionTool.prototype.move = function move(coord) {
        var newFixedCoord = {
    ...
    SelectionTool.prototype.resizeFromHandle = function resizeFromHandle(handle, coord) {
    ...
    SelectionTool.prototype.onKeyDown = function onKeyDown(e) {
        if (this.isActive()) {
            switch (e.keyCode) {
                case 27:
                    // Escape
    ...
    SelectionTool.prototype.onSelectionEnd = function onSelectionEnd() {
    ...
    SelectionTool.prototype.ensureMinimumSize = function ensureMinimumSize() {
    ...
    SelectionTool.prototype.normalise = function normalise() {
        var bounds = this.getBounds();
    ...
    SelectionTool.prototype.emitDimensions = function emitDimensions() {
        var ctx = this.canvas.getContext(),
            bounds = this.getBounds(),
            width = this.width,
            height = this.height;

        this.canvas.publish('before-selection', ctx, _extends({ width: width, height: height }, bounds));
        this.canvas.publish('selection', ctx, _extends({ width: width, height: height }, bounds));
        this.canvas.publish('draw-selection-tool', ctx, { width: width, height: height, posX: bounds.left, posY: bounds.top });
        this.canvas.publish('after-selection', ctx, _extends({ width: width, height: height }, bounds));
    };
    ...
    SelectionTool.prototype.drawSelectionTool = function drawSelectionTool() {
        var ctx = this.canvas.getContext(),
        ...
        this.canvas.publish('clear-selection');
        this.canvas.publish('draw-selection-tool', ctx, { posX: posX, posY: posY, width: width, height: height });
    };
    ...
    SelectionTool.prototype.drawResizeHandles = function drawResizeHandles() {
        var bounds = this.getBounds();
    ...
    SelectionTool.prototype.redraw = function redraw() {
    ...
    SelectionTool.prototype.toString = function toString() {
        var bounds = this.getBounds();
    ...
    SelectionTool.prototype.destroy = function destroy() {
...
},{"./ResizeHandles":296,"./util":298}],298:[function(require,module,exports){
'use strict';
...
exports.isCoordWithinArea = isCoordWithinArea;
exports.normaliseMouseEventToElement = normaliseMouseEventToElement;
exports.parseAspectRatio = parseAspectRatio;
exports.computeActualSizes = computeActualSizes;

function isCoordWithinArea(coord, area) {
    if (coord.x > area.left && coord.x < area.right && coord.y > area.top && coord.y < area.bottom) {
        return true;
    }
    return false;
}
...
function normaliseMouseEventToElement(elem, event) {
    var x = null,
        y = null;
    ...
    if (event.srcElement === elem) {
        ...
        //We are dragging outside the element
...
function parseAspectRatio(aspectRatio) {
    var _aspectRatio$split$map = aspectRatio.split(':').map(function (aspect) {
        return parseInt(aspect, 10);
    });

    var _aspectRatio$split$map2 = _slicedToArray(_aspectRatio$split$map, 2);

    var x = _aspectRatio$split$map2[0];
    var y = _aspectRatio$split$map2[1];
...
function computeActualSizes(selectionData, scaleFactor) {
    return {
